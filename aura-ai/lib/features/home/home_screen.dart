        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // My Journal Hero header
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(
                    AppLocalizations.of(context)!.homeMyJournal,
                    style: GoogleFonts.outfit(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: isDark ? Colors.white : AppColors.text,
              ...
              // Reconstructed Hero Card matching the reference design layout
              IntrinsicHeight(
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    Expanded(
                      child: HeroCard(
                        onContinueTap: () {
                          final state = context
                              .findAncestorStateOfType<_HomeScreenState>();
                          state?._onTabTapped(3); // Shift to Journal tab
                        },
                      ),
                    ),
                    const SizedBox(width: 12),
                    // Evening vertical slider capsule stretching to equal height
                    Container(
                      width: 48,
                      decoration: BoxDecoration(
                        color: isDark
                      ...
                      child: RotatedBox(
                        quarterTurns: 3,
                        child: Text(
                          AppLocalizations.of(context)!.homeEvening,
                          style: GoogleFonts.outfit(
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
                            color: isDark
